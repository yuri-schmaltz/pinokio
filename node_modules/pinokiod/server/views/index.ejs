        ...
        <h1>
          <% if (ishome) { %>
            ...
            <button class='btn2' id='minimize-header' data-tippy-content="fullscreen" title='fullscreen'
              ...
              <div><i class="fa-solid fa-expand" aria-hidden="true"></i></div>
            </button>
            ...
            <button class='btn2' id='screenshot' data-tippy-content="screen capture" aria-label="Take Screenshot"><i
                class="fa-solid fa-camera" aria-hidden="true"></i></button>
            <button class='btn2' id='inspector' data-tippy-content="X-ray mode" aria-label="Inspect UI"><i
                class="fa-solid fa-eye" aria-hidden="true"></i></button>
            <button class='btn2 mobile-link-button' id='mobile-link-button' data-tippy-content="enter url"><i
